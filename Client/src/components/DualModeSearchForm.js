            ...
            {searchMethod === 'ai' && (
              <div className="mt-6 pl-4 border-l-4 border-green-500 bg-gray-800 bg-opacity-30 backdrop-blur-sm rounded-r-lg p-4">
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-gray-800 bg-opacity-50 backdrop-blur-sm rounded-lg p-4 border-2 border-gray-700 shadow-sm">
                    <div className="flex items-start space-x-3">
                      ...
                      <div className="flex-1">
                        ...
                        {structuredExpanded && (
                          <div className="mt-4 p-3 bg-gray-700 bg-opacity-50 rounded-lg border border-gray-600" onClick={(e) => e.stopPropagation()}>
                            <AIModelSelector
